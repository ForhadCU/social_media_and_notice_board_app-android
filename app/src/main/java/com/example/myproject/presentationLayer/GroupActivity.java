...
import com.example.myproject.applicationLayer.strategyDesignPattern.ContextClass;
import com.example.myproject.applicationLayer.strategyDesignPattern.IntentAddMembersClass;
import com.example.myproject.applicationLayer.strategyDesignPattern.IntentCreateNoticeClass;
import com.example.myproject.applicationLayer.strategyDesignPattern.IntentGroupEditClass;
import com.example.myproject.applicationLayer.strategyDesignPattern.IntentGroupMembersClass;
import com.example.myproject.applicationLayer.strategyDesignPattern.IntentNoticesClass;
        ...
        switch (view.getId()) {
            ...
            case R.id.cv_notices:
               ...
               /* IntentClass intentClass = new IntentClass(GroupActivity.this);
                ...
                contextClass.mExecuteStrategy(gDocId, gName);
                break;
            ...
            case R.id.cv_createNotices:
               /* Intent intentCreateNotices = new Intent(this, PostActivity.class);
                ...
                contextClass_2.mExecuteStrategy(gDocId, gName);
                break;
            case R.id.cv_Members:
                ...
                contextClass_3.mExecuteStrategy(gDocId, gName);
                break;
            case R.id.cv_inviteMembers:
               /* Intent intentInviteMembers = new Intent(this, AddMembersActivity.class);
                ...
                contextClass_4.mExecuteStrategy(gDocId, gName);
                break;
            case R.id.cv_editGroups:
               /* Intent intentEditGroups = new Intent(this, EditGroupActivity.class);
                ...
                contextClass_5.mExecuteStrategy(gDocId, gName);
                break;
