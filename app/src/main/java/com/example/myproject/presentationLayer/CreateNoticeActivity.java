...
public class CreateNoticeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private CollectionReference collRefNotices = firestoreDB.collection(Constants.coll_notices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gDocId = intentFromGroupAct.getStringExtra("gDocId");
    ...
    private void mSaveToFireStore( String title, String desc, final String savedImgUri) {
        Data_Handler data_handler = new Data_Handler(currentUid, gDocId, gName,  title, desc, savedImgUri);

        collRefNotices.add(data_handler).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
            public void onSuccess(DocumentReference documentReference) {
                progressDialog.dismiss();
                Toast.makeText(CreateNoticeActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                Intent homeIntent = new Intent(getApplicationContext(), NoticesActivity.class);
                homeIntent.putExtra("gDocId", gDocId);
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(CreateNoticeActivity.this, "Failed to save", Toast.LENGTH_SHORT).show();
